...
console.log('=== DISCOVERY: POPULAR DRAMAS ===');
console.log('Pool:', existing.size);

const discoveries = [];
const urls = [
  'https://api.themoviedb.org/3/discover/tv?api_key=ca9b21cb89de2d1debed1050f603d7ad&with_genres=18&sort_by=popularity.desc&page=1',
  'https://api.themoviedb.org/3/discover/tv?api_key=ca9b21cb89de2d1debed1050f603d7ad&with_genres=18&sort_by=popularity.desc&page=2'
];
